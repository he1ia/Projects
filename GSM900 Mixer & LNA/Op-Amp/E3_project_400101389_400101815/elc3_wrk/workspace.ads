<ADSWorkspace Revision="4" Version="100">
    <Workspace Name="">
        ...
        <Library Name="elc3_lib" />
        <Library Name="TSMC18RF" />
        <Data_Files Name="dc_annotation\elc3_lib_cell_1_schematic\annotation_1.xml" />
        <Data_Files Name="dc_annotation\elc3_lib_cell_1_schematic\annotation_map.xml" />
        <Dataset Name="proj.ds" />
        <Data_Files Name="proj.ds" />
        <Data_Files Name="proj_data\logFile.txt" />
        <Data_Display Name="proj.dds" />
        <Log Name="search_history.log" />
        <Preferences Name="elc3_lib_lay.prf" />
        <Data_Files Name="dc_annotation\elc3_lib_proj_schematic\annotation_1.xml" />
        <Data_Files Name="dc_annotation\elc3_lib_proj_schematic\annotation_map.xml" />
        <Cell Name="elc3_lib:cell_1" />
        <Cell Name="elc3_lib:proj" />
    </Workspace>
</ADSWorkspace>
